...
export default tseslint.config(
  {
    ...
    // `next-env.d.ts` is generated by `next build`, is git-ignored, and is not
    // authored here. It is a triple-slash-reference file, which
    // `@typescript-eslint/triple-slash-reference` rejects — so without this the
    // lint result depends on whether a build has run: green in CI (lint runs
    // before build) and red locally afterwards.
    ignores: [
      '**/node_modules/**',
      '**/.next/**',
      '**/dist/**',
